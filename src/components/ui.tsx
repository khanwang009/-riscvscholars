...
export function Button({
  ...
  const base =
    "inline-flex items-center justify-center transition-colors focus:outline-none disabled:opacity-50 disabled:pointer-events-none px-6 py-2.5 text-[10px] font-bold uppercase tracking-widest border";
  const variants = {
